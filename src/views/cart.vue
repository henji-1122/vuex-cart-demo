  ...
  <div>
    ...
    >
      ...
      <el-table-column
        ...
        label="数量">
        <template v-slot="scope">
          <el-input-number size="mini" :value="scope.row.count" @change="updataProduct({
            prodId:scope.row.id,
            count: $event
          })"></el-input-number>
        </template>
...
export default {
  ...
  methods: {
    ...mapMutations('cart', ['updateAllProductChecked', 'updateProductChecked', 'updataProduct', 'deleteFromCart'])
  }
}
</script>
